...
class Profile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.vendor) {
      ...
      this.setState({ heena: nextProps.vendor.vendor.heena });
  ...
  onSubmit = e => {
    ...
    if (
      ...
      this.props.updatevendormainbyadmin(data, formData);
    } else {
      this.props.updatevendormainbyadmin(data, "");
    }
  };
...
Profile.propTypes = {
  updatevendormainbyadmin: PropTypes.func.isRequired,
...
export default connect(
  mapStateToProps,
  { getCategories, updatevendormainbyadmin, getByHandleVendor }
)(Profile);
